...
24. css3的新特性
> 从新增的文字特效，动画以及新增的关于背景的一些属性，还有背景精灵，边框之类的特性去阐述
25. js实现checkbox全选
```js
...
* style-loader(动态把样式写入页面<style>中)
